...
<div class="col-md-6">
    <div class="panel panel-info">
        <div class="panel-heading"><h3 class="panel-title text-white">Add Expense
        <a href="{{ route('today.expense') }}"class="btn btn-sm btn-danger pull-right">Today</a>
        <a href="{{ route('monthly.expense') }}"class="btn btn-sm btn-success pull-right">This Month</a>
        </h3>
        ...
        <div class="panel-body">
            <form role="form" method="post" action="{{ route('insert-expense') }}">
            	@csrf
