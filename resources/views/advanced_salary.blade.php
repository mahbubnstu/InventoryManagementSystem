...
<div class="col-md-6">
    <div class="panel panel-info">
        <a href="{{ route('all.advancedsalary') }}" class="btn btn-sm btn-danger pull-right">All Advanced Salary</a>
        ...
        <div class="panel-body">
            <form role="form" method="post" action="{{ route('insert-advancedsalary') }}" enctype="multipart/form-data">
            	@csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  placeholder="advanced_salary" name="advanced_salary"required>
                </div>
                <div class="form-group">
