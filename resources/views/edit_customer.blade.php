...
<div class="col-md-6">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form role="form" method="post" action="{{ URL::to('update-customer/'.$edit->id) }}" enctype="multipart/form-data">
            	@csrf
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="shop_name" value="{{ $edit->shop_name }}" required>
                </div>
                 <div class="form-group">
                ...
                <div>
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="account_branch" value="{{ $edit->account_branch }}">
                </div>
                <div class="form-group">
