...
<div class="col-md-6">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form role="form" method="post" action="{{ URL::to('update-employee/'.$edit->id) }}" enctype="multipart/form-data">
            	@csrf
                ...
                <div>
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nid" value="{{ $edit->nid }}"required>
                </div>
                 <div class="form-group">
