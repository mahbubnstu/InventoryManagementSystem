...
<body>
       <body class="fixed-left">
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Mahbub<span class="caret"></span></a>
                                <ul class="dropdown-menu">
        ...
        <script src="{{ asset('admin/assets/jquery-detectmobile/detect.j') }}s"></script>
