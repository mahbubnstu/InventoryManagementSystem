...
<div class="col-md-6">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form role="form" method="post" action="{{ URL::to('update-setting/'.$setting->id) }}" enctype="multipart/form-data">
            	@csrf
                ...
                <div>
                    <img src="{{ URL::to($setting->company_logo) }}" name="old_photo" style="height: 70px;width:70px;">
                </div>
                 <div class="form-group">
